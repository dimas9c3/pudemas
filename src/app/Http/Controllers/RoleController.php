...
class RoleController extends Controller
{
	...
	{
		$this->middleware('permission:master-roles');
		/*$this->middleware('permission:module-courier', ['only' => ['index']]);*/
	}
	...
	{
		$title      = 'Manajemen Roles User | PUDEMAS';
