...
<script>
	$(document).ready(function() {
		...
		L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZGltYXM5YzMiLCJhIjoiY2pxbHdvaHM2MDYyNzQycDd4ZGh4dHBmdiJ9.FzOWqlb9-ejzNFoKuqY1RA', {
			maxZoom: 18,
