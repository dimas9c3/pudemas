...
<script src="{{ asset('template/backend/vendors/js/chart/chart.min.js') }}"></script>
<script src="{{ asset('template/backend/vendors/js/progress/circle-progress.min.js') }}"></script>
...
<!-- Begin Page Snippets -->
<!-- APP Master -->
<script src="{{ asset('js/app_master.js') }}"></script>
<!-- APP Datatables -->
<script type="text/javascript" src="{{ asset('js/app_datatables.js') }}"></script>
<!-- End Page Snippets -->