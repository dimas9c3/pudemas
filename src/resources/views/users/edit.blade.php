    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::password('confirm-password', array('placeholder' => 'Input Lagi Password','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Role: (Bisa pilih lebih dari satu dengan menekan "SHIFT"</strong>
